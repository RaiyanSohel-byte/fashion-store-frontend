...
const Hero = () => {
  return (
    <section className="relative h-[calc(100vh-15rem)] w-full overflow-hidden">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-end pb-24 text-center sm:pb-32">
        <span className="mb-4 text-[10px] font-medium uppercase tracking-luxury text-white/80">
          Automne / Hiver 2026
        </span>
        <h1 className="mb-8 font-serif text-5xl tracking-widest text-white sm:text-7xl md:text-8xl">
          L'Élégance
        </h1>
        <Link
          href="/products"
